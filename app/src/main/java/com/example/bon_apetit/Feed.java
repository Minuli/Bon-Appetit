...
public class Feed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            databaseReference1 = firebaseDatabase.getReference("Customer").child(user.getUid());
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("CustomerPost").child(user.getUid());
            ...
            proimg = findViewById(R.id.customerImage);
            //recycle view
