...
public class updatePost extends AppCompatActivity {
    FirebaseAuth firebaseAuth;
        ...
        Button update,addbutton,delete;
        ImageButton editimg;
        Uri recipieimg;
        ImageView imgview;
    ...
    update.setOnClickListener(new View.OnClickListener() {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                databaseReference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChild("recipename")){
                            databaseReference =FirebaseDatabase.getInstance().getReference("CustomerPost").child(firebaseAuth.getCurrentUser().getUid()).child(recipename.getText().toString());
              ...
              //  storef =FirebaseStorage.getInstance().getReferenceFromUrl(recipieimg) ;
